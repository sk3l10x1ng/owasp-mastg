...
Several automated tools for analyzing iOS apps are available; most are commercial. The free and open-source tools @MASTG-TOOL-0035 and @MASTG-TOOL-0038 provide static and dynamic analysis functionality. Additional tools are on the ["Testing Tools"](../../tools/index.md) page.
