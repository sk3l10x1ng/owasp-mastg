...
@Metadata(d1 = {"\u0000 \n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a'\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u00012\u000e\b\u0002\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00030\u0006H\u0007¢\u0006\u0002\u0010\u0007\u001a\r\u0010\b\u001a\u00020\u0003H\u0007¢\u0006\u0002\u0010\t\u001a\u0015\u0010\n\u001a\u00020\u00032\u0006\u0010\u000b\u001a\u00020\fH\u0007¢\u0006\u0002\u0010\r\u001a\r\u0010\u000e\u001a\u00020\u0003H\u0007¢\u0006\u0002\u0010\t\"\u000e\u0010\u0000\u001a\u00020\u0001X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u000f"}, d2 = {"MASTG_TEXT_TAG", "", "MainScreen", "", "displayString", "onStartClick", "Lkotlin/Function0;", "(Ljava/lang/String;Lkotlin/jvm/functions/Function0;Landroidx/compose/runtime/Composer;II)V", "UpdateCheckingScreen", "(Landroidx/compose/runtime/Composer;I)V", "UpdateRequiredScreen", "state", "Lorg/owasp/mastestapp/MastgTest$UpdateState;", "(Lorg/owasp/mastestapp/MastgTest$UpdateState;Landroidx/compose/runtime/Composer;I)V", "UpdateRequiredScreenPreview", "app_debug"}, k = 2, mv = {2, 0, 0}, xi = 48)
...
public final class MainActivityKt {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit UpdateCheckingScreen$lambda$4(int i, Composer composer, int i2) {
        UpdateCheckingScreen(composer, RecomposeScopeImplKt.updateChangedFlags(i | 1));
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit UpdateRequiredScreen$lambda$7(MastgTest.UpdateState state, int i, Composer composer, int i2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit UpdateRequiredScreenPreview$lambda$8(int i, Composer composer, int i2) {
    ...
    public static final void MainScreen(final String displayString, final Function0<Unit> function0, Composer $composer, final int $changed, final int i) {
        ...
        ComposerKt.sourceInformation($composer2, "C(MainScreen)171@6906L280,171@6866L320:MainActivity.kt#vyvp3i");
        int $dirty = $changed;
        int i2 = i & 1;
        if (i2 != 0) {
            $dirty |= 6;
        ...
        if (($dirty & 91) != 18 || !$composer2.getSkipping()) {
            ...
            BaseScreenKt.BaseScreen(function0, ComposableLambdaKt.rememberComposableLambda(891526107, true, new Function2<Composer, Integer, Unit>() { // from class: org.owasp.mastestapp.MainActivityKt.MainScreen.2
                ...
                public final void invoke(Composer $composer3, int $changed2) {
                    ComposerKt.sourceInformation($composer3, "C172@6916L264:MainActivity.kt#vyvp3i");
                    if (($changed2 & 11) != 2 || !$composer3.getSkipping()) {
                        TextKt.m3574TextNvy7gAk(displayString, TestTagKt.testTag(PaddingKt.m830padding3ABfNKs(Modifier.INSTANCE, Dp.m8394constructorimpl(16)), MainActivityKt.MASTG_TEXT_TAG), Color.INSTANCE.m5687getWhite0d7_KjU(), null, TextUnitKt.getSp(16), null, null, FontFamily.INSTANCE.getMonospace(), 0L, null, null, 0L, 0, false, 0, 0, null, null, $composer3, 25008, 0, 261992);
                        return;
                    }
    ...
    public static final void UpdateCheckingScreen(Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(UpdateCheckingScreen)191@7394L705:MainActivity.kt#vyvp3i");
        if ($changed != 0 || !$composer2.getSkipping()) {
            ...
            int i2 = ((54 >> 6) & 112) | 6;
            ComposerKt.sourceInformationMarkerStart($composer2, -2127104790, "C195@7502L591:MainActivity.kt#vyvp3i");
            ...
            int i4 = ((432 >> 6) & 112) | 6;
            ComposerKt.sourceInformationMarkerStart($composer2, 906252723, "C199@7660L46,200@7719L364:MainActivity.kt#vyvp3i");
            ProgressIndicatorKt.m3149CircularProgressIndicator4lLiAd8(null, Color.INSTANCE.m5687getWhite0d7_KjU(), 0.0f, 0L, 0, 0.0f, $composer2, 48, 61);
            TextKt.m3574TextNvy7gAk("Checking for mandatory updates...", TestTagKt.testTag(PaddingKt.m830padding3ABfNKs(Modifier.INSTANCE, Dp.m8394constructorimpl(16)), MASTG_TEXT_TAG), Color.INSTANCE.m5687getWhite0d7_KjU(), null, TextUnitKt.getSp(16), null, null, FontFamily.INSTANCE.getMonospace(), 0L, null, TextAlign.m8243boximpl(TextAlign.INSTANCE.m8250getCentere0LSkKk()), 0L, 0, false, 0, 0, null, null, $composer2, 25014, 0, 260968);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: org.owasp.mastestapp.MainActivityKt$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return MainActivityKt.UpdateCheckingScreen$lambda$4($changed, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    */
    ...
    public static final void UpdateRequiredScreenPreview(Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(UpdateRequiredScreenPreview)259@9795L59:MainActivity.kt#vyvp3i");
        if ($changed != 0 || !$composer2.getSkipping()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: org.owasp.mastestapp.MainActivityKt$$ExternalSyntheticLambda4
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return MainActivityKt.UpdateRequiredScreenPreview$lambda$8($changed, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
